  ...
  <div class="container1222">
      <div class="options">
       ...
       <div class="specify">
        ...
        <!-- List -->
        <div class="specify2">
        <button id="insertOrderedList" class="option-button activetexteditor" @click="change">
          <i class="icon-ordered-list"></i>
        </button>
        <button id="insertUnorderedList" class="option-button activetexteditor" @click="change">
          <i class="icon-kebab-menu"></i>
        </button>
        </div>
...
change(event){
        ...
        else if(event.target.className === 'subscript-icon')
    {
        ...
        event.target.parentElement.classList.add('texteditoractive')
         ...
         else if(event.target.className === 'icon-kebab-menu')
    {
        this.modifyText(event.target.parentElement.id, false, null);
        event.target.parentElement.classList.add('texteditoractive')
    }
           else if(event.target.className === 'icon-ordered-list')
    {
        this.modifyText(event.target.parentElement.id, false, null);
        event.target.parentElement.classList.add('texteditoractive')
    }
