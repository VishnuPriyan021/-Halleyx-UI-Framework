<template>
  ...
  <p class="component-description">
    The amount of components (pictures, articles, commentaries, pages, etc.)
    that can be loaded inside a specific context is communicated through
    pagination. It provides immediate access to the previous and next content
    item as well as a visual indication of the user's location.
  </p>
    ...
    return {
      ...
      table_data: [
        ...
        },
        {
          ...
          type: "Object",
          accepted_values: "{}",
          default: "{attribute:{rowsPerPageTitlt:true,rowsPerPageResult:true}}",
          mandatory: false,
        },
        {
