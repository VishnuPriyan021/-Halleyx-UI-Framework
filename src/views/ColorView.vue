...
export default {
  ...
  data() {
    return {
      ...
      colorCodes: {
        "Primary colors": ["#30946D", "#54bd95", "#A8DEC9"],
      ...
      colors: {
        ...
        Gradient: {
          "gradiant-left": {
            ...
            to: { value: "#30946d", name: "primary-color-dark" },
          },
          "gradiant-right": {
            angle: "270deg",
            from: { value: "#54bd95", name: "primary-color" },
          ...
          // "gradiant-right": `linear-gradient("to right", "#54bd95", "#30946d")`,

          // "gradiant-down": `linear-gradient("180deg", "#54bd95", "#30946d")`,

          // "gradiant-up": `linear-gradient("360deg", "#54bd95", "#30946d")`,
        },
      },
    };
  },
