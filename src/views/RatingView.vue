<template>
  ...
  <p class="component-description">
    When creating user widgets, the rating component is a specialised yet
    essential component. A straightforward analytical method that can yield a
    wealth of input for your software or product is rating collection from
    users.
  </p>
  ...
  >
    <template #thead>
      <hlx-table-head v-for="(i, index) in this.ratingEvents" :key="index">{{
        i.label
      }}</hlx-table-head>
    </template>
    <template #tbody>
