<template>
  ...
  <div class="component-example">
    <div class="example-body">
      <hlx-file-upload :file_type="'.xlsx,.png,.json'" :file_size_limit="'20mb'" @file_data = "fileData" @delete_file="deleteFile" @preview_file="previewFile" :custom_icon="this.icon" :type="'button'"/>
  ...
  <div class="source-code" id="basic-file-upload" style="display: none">
...
mandatory: false
      ...
      file_upload_source: `
<template>
 <hlx-file-upload :file_type="'.xlsx,.png'" :file_size_limit="'20mb'"/>
</template>`,
    };
  },
  methods: {
