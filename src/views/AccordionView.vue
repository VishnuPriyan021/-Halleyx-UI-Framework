<template>
  ...
  <p class="component-description">
    A menu style known as an accordion shows a series of headings layered on top of one another. These headers will either expose or hide associated content depending on whether they are clicked (or when a keyboard shortcut or screen reader is used).  </p>
    ...
    <div class="example-body">
      ...
      <hlx-accordion :accordion_data="this.example_data" :multiple="false" v-for="(e, index) in this.example_data" :key="index" >
        ...
        <hlx-accordion>
          ...
          <template #item-body>
            <!-- <hlx-switch :switch_items="this.switch_items" @chosen="chosen" /> -->
  ...
  >
    <template #thead>
      <hlx-table-head v-for="(i, index) in this.attributes" :key="index">{{
        i.label
      }}</hlx-table-head>
    </template>
    <template #tbody>
