<template>
  ...
  <a
    ...
    :href="'https://www.npmjs.com/package/halley-kit'"
    target="_blank"
  >
    <div>
      <span class="packager">
  ...
  <section class="package-detail-container">
    <p class="component-description">
      ...
      <strong>halleyx-ui</strong>, so that you can utilize the bundlers.
    </p>
    <div class="language">
      <pre>
      <code>
...
export default {
  ...
  async mounted () {
    const ver = await axios.get('https://registry.npmjs.org/halley-kit/latest')
